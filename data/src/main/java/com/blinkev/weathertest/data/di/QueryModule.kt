...
import com.blinkev.weathertest.data.query.settings.di.SettingsRepoQueriesModule
...
@Module(includes = [CityRepoQueriesModule::class, SettingsRepoQueriesModule::class])
class QueryModule {
